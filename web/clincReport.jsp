        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcumb-content">
                    <h3 class="breadcumb-title">Clinic Report</h3>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <!-- On cells (`td` or `th`) -->
                <tr>
                    <td class="table-active">2021.02.23</td>
                    <td class="table-primary">dr.kamal Gunarathna</td>
                ...
                <!-- On cells (`td` or `th`) -->
                <tr>
                    <td class="table-active">2021.03.21</td>
                    <td class="table-primary">dr.sisila Karunarthna</td>
