        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcumb-content">
                    <h3 class="breadcumb-title">Appointments</h3>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <th class="table-active">Patient ID</th>
                    <th class="table-active">Patient Name</th>
                    <th class="table-active">Date</th>
                    <th class="table-active">Time</th>
                </tr>
                <!-- On cells (`td` or `th`) -->
                <tr>
                    <td class="table-info">0001</td>
                    <td class="table-info">kamal Gunarathna</td>
                    <td class="table-info">2021.05.26</td>
                    <td class="table-info">7.00 PM</td>
    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <th class="table-active">Date</th>
                    <th class="table-active">count</th>
                </tr>
                <!-- On cells (`td` or `th`) -->
                <tr>
